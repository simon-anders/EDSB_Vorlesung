...
Die wahre Differenz zwischen den Mittelwerten ist mit 95 % Wahrscheinleichkeit wirklich ungleich Null. Die beiden Altersklassen der Frauen sind also mit ziemlicher Sicherheit unterschiedlich groß. 
...
nhanes %>%
  filter( age >= 18 ) %>%
  ggplot +
    geom_freqpoly( aes( height, col = ethnicity ), size = .2 ) 
```
